...
class TestViteBundlerTestCase(TestCase):
    ...
    def test_dev_url(self):
        ...
        with override_settings(STATIC_URL="/test-static/"):
            ...
            self.assertEqual(
                "http://localhost:5173/test-static/components/Button.css",
                bundler.get_url(Path("components/Button.css")),
            )
            self.assertEqual(
                "http://localhost:5173/test-static/components/Button.tsx",
            ...
            self.assertEqual("http://localhost:5173/ssr", bundler.get_development_ssr_url())
    ...
    def test_resolve(self):
        ...
        context = ResolveContext(root_dir, "common_frontend/bundler/tests/test_bundler.py")
        self.assertEqual(
            root_dir / "another-app/file.js", bundler.resolve_path("/another-app/file.js", context)
        )
        self.assertEqual(
            root_dir / "common_frontend/bundler/tests/file.js", bundler.resolve_path("./file.js", context)
        )
        self.assertEqual(
            root_dir / "common_frontend/bundler/another-dir/file.js",
