...
LEGACY_COMPONENT_MIGRATIONS: dict[str, LegacyComponentMigration] = {
    ...
    "Content": LegacyComponentMigration("content"),
    "Heading": LegacyComponentMigration("heading"),
    "Header": LegacyComponentMigration("header"),
    "Footer": LegacyComponentMigration("footer"),
