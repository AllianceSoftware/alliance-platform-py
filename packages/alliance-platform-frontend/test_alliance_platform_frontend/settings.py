...
FRONTEND_PRODUCTION_DIR = TEST_DIRECTORY / "frontend/build"


FRONTEND_REACT_PROP_HANDLERS = "alliance_platform_frontend.default_prop_handlers"
FRONTEND_DEBUG_COMPONENT_OUTPUT = False
FRONTEND_BUILD_CACHE = TEST_DIRECTORY / ".frontend-cache/"
FRONTEND_BUNDLER = "test_alliance_platform_frontend.bundler.vite_bundler"
FRONTEND_EXTRACT_ASSETS_EXCLUDE_DIRS = (BASE_DIR / "codegen", re.compile(r".*/site-packages/.*"))
FRONTEND_BUNDLER_DISABLE_DEV_CHECK_HTML = False

VITE_BUNDLER_MODE = "development"

FRONTEND_SSR_GLOBAL_CONTEXT_RESOLVER: str | None = None
