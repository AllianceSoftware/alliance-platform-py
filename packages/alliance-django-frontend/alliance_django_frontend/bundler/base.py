...
class ResolveContext:
    """Passed to :meth:`~common_frontend.bundler.base.PathResolver.resolve` to project context for resolving paths"""
...
class DevServerCheck:
    ...
    def is_wrong_server(self) -> bool:
        ...
        return self.is_running and settings.PROJECT_DIR != self.project_dir
...
class BaseBundler:
    ...
    root_dir: Path
    #: A list of :class:`~common_frontend.bundler.base.PathResolver` instances used to resolve paths
    ...
    def get_preamble_html(self) -> str:
        ...
        Is used by the :meth:`~common_frontend.templatetags.bundler.bundler_preamble` tag.
        """
        return ""
    ...
    def resolve_path(
        ...
        Each resolver in :data:`~common_frontend.bundler.base.BaseBundler.path_resolvers` is called
    ...
    def get_ssr_url(self):
        ...
        :class:`~common_frontend.bundler.middleware.BundlerAssetContextMiddleware` will ``POST`` to this URL
...
class HtmlGenerationTarget:
    """The generation target for HTML produced by templates rendered in :class:`~common_frontend.bundler.context.BundlerAssetContext`

    This is intended to be used in conjunction with things like :class:`~common_frontend.bundler.ssr.BundlerAssetServerSideRenderer`
...
class AssetFileEmbed:
    ...
    These are created by the bundler when :meth:`~common_frontend.bundler.base.BaseBundler.get_embed_items` is called.
