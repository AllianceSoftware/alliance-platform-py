...
from common_frontend.codegen.typescript import Modifier
...
from common_frontend.codegen.typescript import NullKeyword
...
class TypescriptPrinter:
    ...
    def __init__(
        ...
        if relative_to_path is None:
            relative_to_path = settings.PROJECT_DIR
...
class TypescriptSourceFileWriter:
    ...
    #: Path any imports are relative to. Passed to :class:`~common_frontend.codegen.printer.TypescriptPrinter`.
    path_base: Path | None
    ...
    def resolve_import(
        self, source: str | Path, specifier: ImportSpecifier | ImportDefaultSpecifier
    ) -> Identifier:
        """
