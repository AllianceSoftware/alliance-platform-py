...
class FrontendAssetRegistry:
    ...
    :class:`extract_frontend_assets <alliance_platform_frontend.management.commands.extract_frontend_assets.Command>` runs.

    In most cases only a single registry is required. :data:`~alliance_platform_frontend.bundler.asset_registry.frontend_asset_registry`
    ...
    Usage::
        ...
        from alliance_platform_frontend.bundler.asset_registry import frontend_asset_registry
