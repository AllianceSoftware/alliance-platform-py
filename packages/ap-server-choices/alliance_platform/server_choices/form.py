...
def _get_form_field_widget(field: Field, registration: ServerChoiceFieldRegistration):
...
class FormFieldServerChoiceRegistration(ServerChoiceFieldRegistration):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        field.widget = _get_form_field_widget(field, self)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if model is None:
            ...
            filterset_meta = filterset_cls.Meta  # type:ignore[attr-defined]
        ...
        base_filters = filterset_cls.base_filters  # type:ignore[attr-defined]
        base_filters[field_name].extra["widget"] = _get_form_field_widget(field, self)
        super().__init__(
            field=field, class_name=class_name, field_name=field_name, perm=perm, model=model, **kwargs
        )
