...
class GenerateUploadUrlView(View):
    """View to generate a URL using :meth:`~alliance_platform.storage.async_uploads.storage.AsyncUploadStorage.generate_upload_url`.
    ...
    instance the corresponding :class:`~alliance_platform.storage.async_uploads.storage.AsyncUploadStorage` is retrieved along with the permissions
    ...
    returned from :meth:`~alliance_platform.storage.async_uploads.storage.AsyncUploadStorage.generate_upload_url` and the temporary key is returned
    to the frontend. The frontend will submit the returned temporary key from the form and save it on the target model.
    On save the file is then moved to the permanent location using :meth:`~alliance_platform.storage.async_uploads.storage.AsyncUploadStorage.move_file`
...
class DownloadRedirectView(View):
    """View that checks permissions and redirects to a download URL using :meth:`~alliance_platform.storage.async_uploads.storage.AsyncUploadStorage.generate_download_url`.
    ...
    retrieved field instance the corresponding :class:`~alliance_platform.storage.async_uploads.storage.AsyncUploadStorage` is retrieved along
